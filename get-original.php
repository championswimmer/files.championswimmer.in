...
if (strpos($ref,'http://files.championswimmer.in/')===0 || strpos($ref,'http')!==0 || strpos($ref,'http://www.androtransfer.com/')===0){
	header("Location: ".$dlink);
}else{
	$file = $baseDir . "/" . $path;
?>
...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
    ...
    <link type="text/css" rel="stylesheet" href="http://files.championswimmer.in/style.css">
...
<body>
    ...
    <div id="header">
        <table width="100%"><tr><td><img src="http://files.championswimmer.in/images/title.png" width="98%" height="auto"></td>
...
src="http://pagead2.googlesyndication.com/pagead/show_ads.js">
    ...
    <?
	$menu = file_get_contents('http://files.championswimmer.in');
	$menu = fetch($menu,"<div id='links' class='block'>","<div id='page'>");
	$menu = str_replace("?developer=", "http://files.championswimmer.in/?developer=", $menu);
	?>
